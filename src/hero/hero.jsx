...
const Hero = () => {
  return (
    <div className='flex flex-col py-20 justify-center items-center gap-4 bg-black'>
      <div className='w-30'>
      ...
      <div className='w-105'><p className='text-white w-[100%] text-center'>I am a frontend developer, with one year of experience in javascript, TypeScript, React js, Redux along with node js, express js and mongo db.</p></div>
