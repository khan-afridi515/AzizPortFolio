  ...
  return (
    <div className='flex flex-col py-50 px-10 justify-center items-center gap-6 bg-black w-full'>
      ...
      <Link to="contact" smooth={true} duration={600} className="mr-4 cursor-pointer"><button type="button" className='px-5 py-2 text-white bg-blue-500 rounded-full cnct'>Connect with me</button></Link>
        <button type="button" className='border border-pink-500 px-5 py-2 text-pink-500 rounded-full resumy'><a href="/Aziz_Ullah_MERN_Stack_CV (2).pdf" download>My Resumy</a></button>
      </div>
    </div>
  )
}
